...
public class ReactorEssentialsTest {
    ...
    @Test
    @Ignore
    void endlessStreamAndCauseAnError() {
        Flux.range(1, 100)
                .repeat()
                .collectList()
                .block();
    ...
    @Test
    void subscribingOnStream() throws Exception {
    ...
    @Test
    void startStopStreamProcessing() throws Exception {
    ...
    @Test
    void sampleExample() throws InterruptedException {
        Flux.range(1, 100)
    ...
    @Test
    void usingWhenExample() throws InterruptedException {
        Flux.usingWhen(
    ...
    @Test
    void usingPushOperator() throws InterruptedException {
    ...
    @Test
    void usingCreateOperator() throws InterruptedException {
        Flux.create(emitter -> {
    ...
    @Test
    void usingGenerate() throws InterruptedException {
        Flux.generate(
                () -> Tuples.of(0L, 1L),
                (state, sink) -> {
    ...
    @Test
    void cachingExample() throws InterruptedException {
    ...
    @Test
    void replayExample() throws InterruptedException {
    ...
    @Test
    void elapsedExample() throws InterruptedException {
        Flux.range(0, 5)
                .delayElements(Duration.ofMillis(100))
                .elapsed()
